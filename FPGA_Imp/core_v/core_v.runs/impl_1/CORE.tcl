...
set rc [catch {
  ...
  add_files -quiet D:/Mustafa/Projects/Digital_Design/Si_Clash/DFE_Filter_Array/FPGA_Imp/core_v/core_v.runs/synth_1/CORE.dcp
  read_xdc D:/Mustafa/Projects/Digital_Design/Si_Clash/DFE_Filter_Array/FPGA_Imp/cstr_core.xdc
  link_design -top CORE -part xc7a200tffg1156-3
...
set rc [catch {
  ...
  write_bitstream -force CORE.bit 
