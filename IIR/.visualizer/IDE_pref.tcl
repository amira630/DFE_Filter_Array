...
set perspective_DateTime   {2025-11-21T06:19:43}
set perspective_Directory  {D:/Mustafa/Projects/Digital_Design/Si_Clash_N/Design/DFE_Filter_Array/IIR}
set perspective_USER       {Mustafa}
...
pref::set -type string -category General -name IDEVisibleWindows -value Lint###source,zinlintMsgStatusHistoryView,zinmsgviewer,zinlintMsgSummaryView,zinlintDesignInfoView,transcript,zinlintMsgView,zinlintDesignMetricsView,zinlintMsgDashboardView,zinflownavigator,source -hide -description none -label none
...
pref::set -type string -category Lint -name lintMessagesviewDefaultOrderWidth -value Severity:127,Status:60,Check:250,Alias:100,Message:500,Module:150,Category:150,State:100,Owner:100,STARC*Reference:361 -hide -description none -label none
pref::set -type string -category Lint -name lintMessagesviewToolButtonFilters -value Uninspected,Bug -hide -description none -label none
pref::set -type string -category Lint -name lintMessagesviewToolButtonFiltersTuple -value Status!-!Equals!-!bug!@!Status!-!Equals!-!uninspected -hide -description none -label none
pref::set -type string -category Lint -name lintMessagesviewDialogFilters -value {} -hide -description none -label none
pref::set -type string -category Lint -name lintMessagesviewPythonFilterStr -value {lintToolButtonStatusFilter!-!((df["Status"].str.contains("^(?s:bug)$", case=True)) | (df["Status"].str.contains("^(?s:uninspected)$", case=True)))} -hide -description none -label none
